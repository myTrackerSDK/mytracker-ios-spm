 ...
 */
+ (void)trackLoginEvent:(NSString *)userId withVkConnectId:(NSString * _Nullable)vkcId;
 ...
 */
+ (void)trackLoginEvent:(NSString *)userId withVkConnectId:(NSString * _Nullable)vkcId params:(nullable NSDictionary<NSString *, NSString *> *)eventParams;
...
/**
 ...
 @param userId Unique user identifier.
*/
+ (void)trackRegistrationEvent:(NSString *)userId withVkConnectId:(NSString * _Nullable)vkcId;
...
/**
 ...
 @param eventParams Any optional parameters can be passed with event as «key-value» by optional parameter eventParams. Max key or value length — 255 chars.
*/
+ (void)trackRegistrationEvent:(NSString *)userId withVkConnectId:(NSString * _Nullable)vkcId params:(nullable NSDictionary<NSString *, NSString *> *)eventParams;
...
*/
+ (void)trackAdEvent:(MRAdEvent *)event NS_SWIFT_NAME(trackAdEvent(_:));
...
/**
 ...
 @return BOOL value.
*/
+ (BOOL)continueUserActivity:(NSUserActivity *)userActivity restorationHandler:(nullable void(^)(NSArray * _Nullable restorableObjects))restorationHandler;
...
/**
 ...
 @return BOOL value.
*/
+ (BOOL)handleOpenURL:(NSURL *)url sourceApplication:(nullable NSString *)sourceApplication annotation:(nullable id)annotation;
