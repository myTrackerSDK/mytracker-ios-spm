 ...
 */
+ (void)setAttributionDelegate:(nullable id <MRMyTrackerAttributionDelegate>)delegate NS_SWIFT_NAME(setAttribution(delegate:));
...
+ (void)setAttributionDelegate:(nullable id <MRMyTrackerAttributionDelegate>)delegate
				 delegateQueue:(nullable NSOperationQueue *)queue NS_SWIFT_NAME(setAttribution(delegate:queue:));
 ...
 */
+ (void)setDebugMode:(BOOL)enabled NS_SWIFT_NAME(setDebugMode(enabled:));
 ...
 */
+ (BOOL)isDebugMode NS_SWIFT_NAME(isDebugMode());
...
*/
+ (NSString *)trackerVersion NS_SWIFT_NAME(trackerVersion());
 ...
 */
+ (MRMyTrackerParams *)trackerParams NS_SWIFT_NAME(trackerParams());
 ...
 */
+ (MRMyTrackerConfig *)trackerConfig NS_SWIFT_NAME(trackerConfig());
 ...
 */
+ (void)setupTracker:(NSString *)trackerId NS_SWIFT_NAME(setupTracker(_:));
 ...
 */
+ (void)trackEventWithName:(NSString *)name NS_SWIFT_NAME(trackEvent(name:));
...
+ (void)trackEventWithName:(NSString *)name
			   eventParams:(nullable NSDictionary<NSString *, NSString *> *)eventParams NS_SWIFT_NAME(trackEvent(name:eventParams:));
...
+ (void)trackLoginEvent:(NSString *)userId
		withVkConnectId:(NSString * _Nullable)vkcId NS_SWIFT_NAME(trackLoginEvent(userId:vkConnectId:));
...
+ (void)trackLoginEvent:(NSString *)userId
		withVkConnectId:(NSString * _Nullable)vkcId
				 params:(nullable NSDictionary<NSString *, NSString *> *)eventParams NS_SWIFT_NAME(trackLoginEvent(userId:vkConnectId:eventParams:));

/**
 @discussion Call the method if current user has invited other user.
 */
+ (void)trackInviteEvent NS_SWIFT_NAME(trackInviteEvent());
...
*/
+ (void)trackInviteEventWithParams:(nullable NSDictionary<NSString *, NSString *> *)eventParams  NS_SWIFT_NAME(trackInviteEvent(eventParams:));
...
/**
 ...
 @param userId Unique user identifier.
*/
+ (void)trackRegistrationEvent:(NSString *)userId withVkConnectId:(NSString * _Nullable)vkcId NS_SWIFT_NAME(trackRegistrationEvent(userId:vkConnectId:));
...
+ (void)trackRegistrationEvent:(NSString *)userId
			   withVkConnectId:(NSString * _Nullable)vkcId
						params:(nullable NSDictionary<NSString *, NSString *> *)eventParams NS_SWIFT_NAME(trackRegistrationEvent(userId:vkConnectId:eventParams:));
...
+ (void)trackPurchaseWithProduct:(SKProduct *)product
					 transaction:(SKPaymentTransaction *)transaction NS_SWIFT_NAME(trackPurchase(product:transaction:));
...
+ (void)trackPurchaseWithProduct:(SKProduct *)product
					 ...
					 eventParams:(nullable NSDictionary<NSString *, NSString *> *)eventParams NS_SWIFT_NAME(trackPurchase(product:transaction:eventParams:));

/**
 @discussion Call the method when user achieve new level.
*/
+ (void)trackLevelAchieved NS_SWIFT_NAME(trackLevelAchieved());
...
*/
+ (void)trackLevelAchievedWithLevel:(nullable NSNumber *)level NS_SWIFT_NAME(trackLevelAchieved(level:));
...
+ (void)trackLevelAchievedWithLevel:(nullable NSNumber *)level
						eventParams:(nullable NSDictionary<NSString *, NSString *> *)eventParams NS_SWIFT_NAME(trackLevelAchieved(level:eventParams:));
...
*/
+ (void)trackAdEvent:(MRAdEvent *)event NS_SWIFT_NAME(trackAdEvent(_:)) NS_SWIFT_NAME(trackAdEvent(_:));
 ...
 */
+ (void)trackMiniAppEvent:(MRMiniAppEvent *)event NS_SWIFT_NAME(trackMiniAppEvent(_:));
...
+ (BOOL)continueUserActivity:(NSUserActivity *)userActivity
		  restorationHandler:(nullable void(^)(NSArray * _Nullable restorableObjects))restorationHandler NS_SWIFT_NAME(continue(userActivity:restorationHandler:));
...
+ (BOOL)handleOpenURL:(NSURL *)url
	sourceApplication:(nullable NSString *)sourceApplication
		   annotation:(nullable id)annotation NS_SWIFT_NAME(handleOpen(url:sourceApplication:annotation:));
...
/**
 ...
 @return BOOL value.
*/
+ (BOOL)handleOpenURL:(NSURL *)url options:(nullable NSDictionary *)options NS_SWIFT_NAME(handleOpen(url:options:));
