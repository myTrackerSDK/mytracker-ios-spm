...
*/
+ (MRAdEventBuilder *)newClickBuilder:(MRAdNetwork)network NS_SWIFT_NAME(newClickBuilder(network:));
...
@return MRAdEventBuilder instance
*/
+ (MRAdEventBuilder *)newImpressionBuilder:(MRAdNetwork)network NS_SWIFT_NAME(newImpressionBuilder(network:));
...
+ (MRAdEventBuilder *)newRevenueBuilder:(MRAdNetwork)network
							   ...
							   currency:(NSString *)currency NS_SWIFT_NAME(newRevenueBuilder(network:revenue:currency:));
...
@return MRAdEventBuilder instance
*/
- (MRAdEventBuilder *)withSource:(nullable NSString *)source NS_SWIFT_NAME(withSource(_:));
...
@return MRAdEventBuilder instance
*/
- (MRAdEventBuilder *)withPlacementId:(nullable NSString *)placementId NS_SWIFT_NAME(withPlacementId(_:));
...
@return MRAdEventBuilder instance
*/
- (MRAdEventBuilder *)withAdId:(nullable NSString *)adId NS_SWIFT_NAME(withAdId(_:));
...
@return MRAdEventBuilder instance
*/
- (MRAdEventBuilder *)withAdFormat:(nullable NSString *)format NS_SWIFT_NAME(withAdFormat(_:));
